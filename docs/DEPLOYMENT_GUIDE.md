...
| `clanLeaderboardJob.refresh` | `us-central1` | Cloud Scheduler (`every 6 hours`) | Writes top-100 clan leaderboard to `/ClanLeaderboard/snapshot`. |
| `leaderboards.refreshAll` | `us-central1` | Cloud Scheduler (`every 6 hours`) | Recomputes player leaderboards (XP, trophies, etc.). |
